...
const social_icons = {
  "vk": require('@/assets/images/icons/social/outline/vk.svg'),
  "tg": require('@/assets/images/icons/social/outline/tg.svg'),
  "ig": require('@/assets/images/icons/social/outline/ig.svg')
}
