<template>
  <div class="flex flex-wrap">
    ...
    <div class="flex flex-row items-center px-3 gap-3 basis-full lg:basis-2/3 mt-2 lg:mt-0">
      <span class="text-xl text-gray-400">{{ user.telegram ? '@' + user.telegram : "Не подключен" }}</span>
      <button class="btn btn-accent flex-shrink-0" @click="openTelegram">
