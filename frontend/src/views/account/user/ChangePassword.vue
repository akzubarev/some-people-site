<template>
  <div class="rounded-xl bg-gray-700 bg-opacity-60 p-6">

    <Form class="form flex flex-col gap-3" novalidate="novalidate"
          @submit="savePassword">
      ...
      <div class="flex max-sm:flex-col gap-3">
        <div class="relative basis-full lg:basis-1/3">
          ...
          <span v-if="errors.current_password" class="input-error-message">{{
        ...
        <div class="relative basis-full lg:basis-1/3">
          ...
          <span v-if="errors.new_password"
                class="input-error-message">{{ errors.new_password }}</span>
        </div>
        <div class="relative basis-full lg:basis-1/3">
          <Field
              type="text"
          ...
          <span v-if="errors.re_password"
                class="input-error-message">{{ errors.re_password }}</span>
        </div>
      </div>
      <button
          type="submit"
