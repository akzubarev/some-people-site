...
class LayoutService {
  ...
  public static initLayout(): void {
    store.dispatch("body/" + Actions.ADD_BODY_ATTRIBUTE, {
      qulifiedName: "id",
      value: "kt_body"
    })
    ...
    if (objectPath.get(config.value, "loader.display")) {
      store.dispatch(
        "body/" + Actions.ADD_BODY_CLASSNAME,
        "page-loading-enabled"
      )
      store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "page-loading")
    }
  }
  ...
  public static initHeader(): void {
    if (objectPath.get(config.value, "header.fixed.desktop")) {
      store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "header-fixed")
    }
  ...
  public static initToolbar(): void {
    ...
    store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "toolbar-enabled")

    if (objectPath.get(config.value, "toolbar.fixed")) {
      store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "toolbar-fixed")
    }
  ...
  public static initAside(): void {
    ...
    // Enable Aside
    store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "aside-enabled")
    ...
    if (
      ...
      store.dispatch("body/" + Actions.ADD_BODY_ATTRIBUTE, {
        qulifiedName: "data-kt-aside-minimize-toggle",
        value: "on"
      })
    }
    ...
    if (objectPath.get(config.value, "aside.fixed")) {
      // Fixed Aside
      store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "aside-fixed")
    }
  ...
  public static initFooter(): void {
    ...
    if (objectPath.get(config.value, "footer.width") === "fixed") {
      store.dispatch("body/" + Actions.ADD_BODY_CLASSNAME, "footer-fixed")
    }
  }
}
